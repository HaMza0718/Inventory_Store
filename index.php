				...
				<div class="tab-content" id="v-pills-tabContent">
					<div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
						<div class="card card-outline-secondary my-4">
							<div class="text-info card-header">Item Details</div>
							<div class="card-body">
								...
								<div class="tab-content">
									<div id="itemDetailsTab" class="container-fluid tab-pane active">
										...
										<form>
											...
											<button type="button" id="addItem" class="btn btn-info">Add Item</button>
											...
											<button type="reset" class="btn btn-dark" id="itemClear">Clear</button>
										</form>
									</div>
										...
										<form name="imageForm" id="imageForm" method="post">
											...
											<div class="form-row">
												<div class="form-group col-md-7">
													...
													<input type="file" class="form-control-file btn btn-light" id="itemImageFile" name="itemImageFile">
												</div>
											</div>
											<br>
											<button type="button" id="updateImageButton" class="btn btn-info">Upload Image</button>
					...
					<div class="tab-pane fade" id="v-pills-purchase" role="tabpanel" aria-labelledby="v-pills-purchase-tab">
						<div class="card card-outline-secondary my-4">
							<div class="text-info card-header">Purchase Details</div>
							<div class="card-body">
								...
								<form>
									...
									<button type="button" id="addPurchase" class="btn btn-info">Add Purchase</button>
					...
					<div class="tab-pane fade" id="v-pills-vendor" role="tabpanel" aria-labelledby="v-pills-vendor-tab">
						<div class="card card-outline-secondary my-4">
							<div class="text-info card-header">Vendor Details</div>
							<div class="card-body">
								<!-- Div to show the ajax message from validations/db submission -->
								...
								<form>
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											...
											<input placeholder="Auto Generate" type="text" class="form-control invTooltip" id="vendorDetailsVendorID" name="vendorDetailsVendorID" title="This will be auto-generated when you add a new vendor" autocomplete="off">
											<div id="vendorDetailsVendorIDSuggestionsDiv" class="customListDivWidth"></div>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-3">
											<label for="vendorDetailsVendorMobile">Contact No<span class="requiredIcon">*</span></label>
										...
										<!-- <div class="form-group col-md-3">
							<label for="vendorDetailsVendorPhone2">Contact 2 (optional)</label>
						...
						<input type="text" class="form-control" id="vendorDetailsVendorAddress2" name="vendorDetailsVendorAddress2">
									...
									<button type="button" id="addVendor" name="addVendor" class="btn btn-info">Add Vendor</button>
					...
					<div class="tab-pane fade" id="v-pills-sale" role="tabpanel" aria-labelledby="v-pills-sale-tab">
						<div class="card card-outline-secondary my-4">
							<div class="text-info card-header">Sale Details</div>
							<div class="card-body">
								...
								<form>
									...
									<button type="button" id="addSaleButton" class="btn btn-info">Add Sale</button>
									<button type="button" id="updateSaleDetailsButton" class="btn btn-primary">Update</button>
									<button type="reset" id="saleClear" class="btn btn-dark">Clear</button>
								</form>
							</div>
						</div>
					</div>
					<div class="tab-pane fade" id="v-pills-customer" role="tabpanel" aria-labelledby="v-pills-customer-tab">
						<div class="card card-outline-secondary my-4">
							<div class="text-info card-header">Customer Details</div>
							<div class="card-body">
								<!-- Div to show the ajax message from validations/db submission -->
								...
								<form>
									...
									<div class="form-row">
										<div class="form-group col-md-3">
											<label for="customerDetailsCustomerMobile">Contact No<span class="requiredIcon">*</span></label>
										...
										<!-- <div class="form-group col-md-3">
							<label for="customerDetailsCustomerPhone2">Contact 2 (optional)</label>
							<input type="text" class="form-control invTooltip" id="customerDetailsCustomerPhone2" name="customerDetailsCustomerPhone2" title="Do not enter leading 0">
									...
									<button type="button" id="addCustomer" name="addCustomer" class="btn btn-info">Add Customer</button>
					...
					<div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
						<div class="card card-outline-secondary my-4">
							<div class="text-info card-header">Search Records<button id="searchTablesRefresh" name="searchTablesRefresh" class="btn btn-success float-right btn-sm">Refresh</button></div>
							<div class="card-body">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
					...
					<div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
						<div class="card card-outline-secondary my-4">
							<div class="text-info card-header">Reports<button id="reportsTablesRefresh" name="reportsTablesRefresh" class="btn btn-success float-right btn-sm">Refresh</button></div>
							<div class="card-body">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
								...
								<div class="tab-content">
									...
									<div id="saleReportsTab" class="container-fluid tab-pane fade">
										...
										<form>
											...
											<button type="button" id="showSaleReport" class="btn btn-info">Show Report</button>
											<button type="reset" id="saleFilterClear" class="btn btn-dark">Clear</button>
										</form>
										<br><br>
									...
									<div id="purchaseReportsTab" class="container-fluid tab-pane fade">
										...
										<form>
											...
											<button type="button" id="showPurchaseReport" class="btn btn-info">Show Report</button>
											<button type="reset" id="purchaseFilterClear" class="btn btn-dark">Clear</button>
										</form>
										<br><br>
